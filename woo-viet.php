 ...
 * Plugin URI: https://github.com/PandaCodeLimited/wordpress_onepay_plugin
 * Description: This plugin provides features and integrations specifically for Vietnam, cloned from author https://profiles.wordpress.org/htdat, however it seem outdated and not supported our case, therefore it need to be replaced (not have enough translate, some features missing out).
 * Author: Nhat
 * Author URI: https://pandacodeglobal.com
